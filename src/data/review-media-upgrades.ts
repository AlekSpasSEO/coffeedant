...
export const reviewMediaUpgrades: Record<string, ReviewMediaSeed[]> = {
  '/espresso-machine/quick-mill-alexia-evo-flow/': retailerProductMedia(
    ...
    [
      {
        src: 'https://espressooutlet.com/cdn/shop/files/alexia-evo-front.webp?v=1709839465&width=1000',
      ...
      {
        src: 'https://espressooutlet.com/cdn/shop/files/0970-A-CEVO-3.jpg?v=1709839467&width=1000',
